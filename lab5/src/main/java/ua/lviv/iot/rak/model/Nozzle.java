...
public class Nozzle {
    ...
    private Integer maxWaterConsumption;
    ...
    public Integer getMaxWaterConsumption() {
        return maxWaterConsumption;
    }

    public void setMaxWaterConsumption(Integer maxWaterConsumption) {
